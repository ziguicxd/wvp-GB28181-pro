...
public interface CommonGBChannelMapper {
        ...
        List<CommonGBChannel> queryInListByStatus(List<CommonGBChannel> commonGBChannelList,
        ...
        @Update(value = { " <script>" +
                        ...
                        " </script>" })
        void reset(@Param("id") int id, @Param("dataType") Integer dataType, @Param("dataDeviceId") int dataDeviceId,
        ...
        @Select("<script>" +
                        ...
                        " </script>")
        List<RegionTree> queryForRegionTreeByCivilCode(@Param("query") String query,
        ...
        List<CommonGBChannel> queryByIdsOrCivilCode(@Param("civilCode") String civilCode,
        ...
        @Update(value = { " <script>" +
                        ...
                        +
                        " </script>" })
        int updateBusinessGroupByChannelList(@Param("businessGroup") String businessGroup,
        ...
        List<CommonGBChannel> queryShareChannelByParentId(@Param("parentId") String parentId,
                        @Param("platformId") Integer platformId);

        @SelectProvider(type = ChannelProvider.class, method = "queryShareChannelByCivilCode")
        List<CommonGBChannel> queryShareChannelByCivilCode(@Param("civilCode") String civilCode,
                        @Param("platformId") Integer platformId);
        ...
        List<CommonGBChannel> queryListByStreamPushList(@Param("dataType") Integer dataType,
                        List<StreamPush> streamPushList);
        ...
        @Select("<script>" +
                        ...
                        "</script>")
        List<CommonGBChannel> queryForRecordPlanForWebList(@Param("planId") Integer planId,
        ...
        List<CommonGBChannel> queryListByCivilCodeForUnusual(@Param("query") String query,
                        @Param("online") Boolean online, @Param("dataType") Integer dataType);
