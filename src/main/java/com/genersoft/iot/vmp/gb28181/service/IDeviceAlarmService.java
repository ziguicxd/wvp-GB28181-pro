...
public interface IDeviceAlarmService {
     ...
     * @param alarmMethod   报警方式 , 1为电话报警, 2为设备报警, 3为短信报警, 4为 GPS报警, 5为视频报警,
     *                      6为设备故障报警,
     ...
     * @return 报警列表
     */
    PageInfo<DeviceAlarm> getAllAlarm(int page, int count, String deviceId, String channelId, String alarmPriority,
            String alarmMethod,
