...
public class DefaultProperties {
    ...
    public static Properties getProperties(String name, boolean sipLog, boolean sipCacheServerConnections) {
         ...
         * sip消息的解析在
         * gov.nist.javax.sip.stack.UDPMessageChannel的processIncomingDataPacket方法
         */
