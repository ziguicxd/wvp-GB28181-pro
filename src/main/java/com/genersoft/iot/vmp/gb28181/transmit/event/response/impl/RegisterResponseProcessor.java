...
public class RegisterResponseProcessor extends SIPResponseProcessorAbstract {
	...
	public void process(ResponseEvent evt) {
		...
		if (subscribe == null || subscribe.getSipTransactionInfo() == null
				|| subscribe.getSipTransactionInfo().getUser() == null) {
			return;
		}
		...
		if (response.getStatusCode() == Response.UNAUTHORIZED) {
			...
			try {
				sipCommanderForPlatform.register(platform, sipTransactionInfo, www, null, null,
						subscribe.getSipTransactionInfo().getExpires() > 0);
