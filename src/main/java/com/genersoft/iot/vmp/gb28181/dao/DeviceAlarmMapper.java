...
public interface DeviceAlarmMapper {
        ...
        @Select(value = { " <script>" +
                        ...
                        " </script>" })
        List<DeviceAlarm> query(@Param("deviceId") String deviceId, @Param("channelId") String channelId,
                        @Param("alarmPriority") String alarmPriority, @Param("alarmMethod") String alarmMethod,
        ...
        @Delete(" <script>" +
                        ...
                        " </script>")
        int clearAlarmBeforeTime(@Param("id") Integer id, @Param("deviceIdList") List<String> deviceIdList,
