 ...
 * 发布 PUBLISH alarm_receive '{ "gbId": "", "alarmSn": 1, "alarmType": "111",
            ...
            try {
                ...
                if (ObjectUtils.isEmpty(chanelId)) {
                    if (userSetting.getSendToPlatformsWhenIdLost()) {
                        // 发送给所有的上级
                        List<Platform> parentPlatforms = platformService
                                .queryEnablePlatformList(userSetting.getServerId());
                        ...
                        // 获取开启了消息推送的设备和平台
                        List<Platform> parentPlatforms = mobilePositionService
                    ...
                    if (device != null && device.getServerId().equals(userSetting.getServerId())
